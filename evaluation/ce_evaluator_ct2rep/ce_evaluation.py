...
import numpy as np
import os
os.environ["CUDA_VISIBLE_DEVICES"] = os.environ.get("CE_CUDA_DEVICES", "0")
import torch
...
############################# label inference #############################
# path
csv_path = os.environ.get("RESULTS_PATH", "../../results/evaluation/full/reports_rm_region_text.csv")
...
model_path = os.environ.get("RADBERT_MODEL_PATH", "../../models/Reg2RG/RadBertClassifier.pth")
