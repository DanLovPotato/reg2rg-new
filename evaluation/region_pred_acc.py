...
results_path = os.environ.get("RESULTS_PATH", "../results/evaluation/full/reports.csv")
df = pd.read_csv(results_path)

gt_combined_reports = df["GT_combined_report"].tolist()
pred_combined_reports = df["Pred_combined_report"].tolist()
...
for accnum, gt_regions, pred_regions in zip(accnums, gt_region_descriptions, pred_region_descriptions):
    for region, area in gt_regions.items():
        ...
        elif pred_regions.get(region) in REGIONS:
